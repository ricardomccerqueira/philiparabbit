var Rabbit = {
    ...
    setRabbitScroll:function() {

    },

    handleRabbitScroll:function(){
       // $("#filler1").position().top
       // $(window).scrollTop()
    },
    ...
    viewInteractions:{
        ...
        filler1:{
            on:function(){
                /*if(Rabbit.video1Loaded == false){
                    Rabbit.video1Loaded = true;
                    Rabbit.video1.src({ type: "video/mp4", src: "video/filler1.mp4" });
                }

                Rabbit.video1.on("ended",function(){
                    Rabbit.video1.play();
                });
            ...
            off:function(){
               /* Rabbit.video1.off("ended");
                Rabbit.video1.pause();
                Rabbit.video1.currentTime(0.7);*/
            },
            onTop:function(){
    ...
    handleWindowResize:function() {
        ...
        $("#filler1_video").width($("#filler1_img").width());
        $("#filler1_video").height($("#filler1_img").height());
        ...
        setTimeout(function(){
            $.each($("#galleryimages div.galleryitem"), function() {
                ...
                $(this).height($(this).find('figure img').height());
                $(this).find("div").width($(this).width()*$(this).find('figure img').length);
